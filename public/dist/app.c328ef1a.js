...
var Tabs = {
  view: function view() {
    return [(0, _mithril.default)("input[id='radio1'][type='radio'][name='css-tabs']"), (0, _mithril.default)("input[id='radio2'][type='radio'][name='css-tabs']", {
      onclick: function () {
        var _onclick = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          var clientsList, clientsArray;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 2:
                  clientsList = _context.sent;
                  clientsArray = clientsList.map(function (client) {
                    return (0, _mithril.default)("li.client-list-item[url=".concat(client._id, "]"), (0, _mithril.default)("h1#client-name", client.name + ' ' + client.surname), (0, _mithril.default)('span', 'mail: ' + client.mail), (0, _mithril.default)("span", client.orders));
                  });
                  console.log(clientsArray);
                  console.log(clientsList);

                  _mithril.default.mount(document.querySelector('.client-list'), {
                    view: function view() {
                      return clientsArray;
                    }
                  });
    ...
    }), (0, _mithril.default)("input[id='radio3'][type='radio'][name='css-tabs']"), (0, _mithril.default)("[id='tabs']", [(0, _mithril.default)("label.tab-orders[id='tab1 tab-orders'][for='radio1']", "Orders"), (0, _mithril.default)("label.tab-clients[id='tab2 tab-clients'][for='radio2']", "Clients"), (0, _mithril.default)("label.tab-history[id='tab3 tab-history'][for='radio3']", "History")]), (0, _mithril.default)("[id='content']", // ORDERS HANDLER
    [(0, _mithril.default)("section.container[id='content1']", [(0, _mithril.default)("h3", "Your Orders"), (0, _mithril.default)(".orders-container", [(0, _mithril.default)(".create-order", [(0, _mithril.default)("button.button", {
      onclick: function onclick() {
        _mithril.default.mount(document.querySelector('.new-order'), {
          view: function view() {
            return (0, _mithril.default)('.order-div', [(0, _mithril.default)("h1#client-name", 'TEST'), (0, _mithril.default)("input.search-client-name"), (0, _mithril.default)(".order-items-list"), (0, _mithril.default)(".date")]);
          }
        });
      }
    }, "New Order")]), (0, _mithril.default)('.new-order')])]), // CLIENT HANDLER
    (0, _mithril.default)("section.container[id='content2']", [(0, _mithril.default)("h3", "Client List"), (0, _mithril.default)("div.client-content", [(0, _mithril.default)("div.new-client.row", [(0, _mithril.default)("button.button", {
      onclick: function onclick(e) {
        document.querySelector('.new-client.row').classList.toggle('reveal-inputs');
      }
    }, "New Client"), (0, _mithril.default)("div.new-client-inputs.row", [(0, _mithril.default)("input[type='text'][name='client-name'][value=''][placeholder='Name']", {
      style: "text-transform: capitalize"
    }), (0, _mithril.default)("input[type='text'][name='client-surname'][value=''][placeholder='Surname']", {
      style: "text-transform: capitalize"
    }), (0, _mithril.default)("input[type='text'][name='client-mail'][value=''][placeholder='Email']", {
      style: "text-transform: lowercase"
    }), (0, _mithril.default)("button.button[type='submit']", {
      onclick: function () {
    ...
    }, "Add Client")])]), (0, _mithril.default)("ul.client-list")])]), (0, _mithril.default)("section.container[id='content3']", [(0, _mithril.default)("h3", "A History of your Searches"), (0, _mithril.default)("div.searches-content")])])];
  }
};
module.exports = Tabs;
},{"mithril":"../node_modules/mithril/index.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var loginPopout = document.querySelectorAll('.user-icon');
var loginButton = document.querySelector('.login-button'); //check if session exists
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            try {
              ...
              session.user = 'ntaov'; // session = await fetch('/logged').then(res => res.json())
...
_mithril.default.mount(document.querySelector('div.user-personal-bucket'), _Tabs.default);

var tabHandler = {
  handler: function handler() {
    // select the first tab
    document.querySelector('#radio1').checked = true; // add a listener
  ...
  clients: function () {
    var _clients = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
  ...
  history: function () {
    var _history = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var searches, searchesArray;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _mithril.default.request({
                method: "GET",
                url: "/api/".concat(session.user, "/OrderInstances")
              });
            ...
            case 2:
              ...
              searchesArray = searches.map(function (item) {
                console.log(item);
                return (0, _mithril.default)(".search-instance[url=".concat(item._id, "]"), (0, _mithril.default)("span", "".concat(item.year).concat(item.season, " ").concat(item.model, " ").concat(item.color, " ").concat(item.size)), (0, _mithril.default)(".search-date", item.date), (0, _mithril.default)(".search-user", item.user));
              });

              _mithril.default.mount(document.querySelector('.searches-content'), {
                view: function view() {
                  return (0, _mithril.default)("div.table.u-full-width", searchesArray);
                }
              });
...
tabHandler.handler(); // SIDEBAR DROPDOWN

loginPopout.forEach(function (item) {
  item.addEventListener('click', function () {
    classy('.user-panel', 'hidden', 'toggle');
  });
}); // LOGIN

loginButton.onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
...
button.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
  var model, color, user, start, end, elapsed;
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          model = document.querySelector('.model-input').value === '' ? 'm' : document.querySelector('.model-input').value;
          color = document.querySelector('.color-input').value === '' ? 'c' : document.querySelector('.color-input').value;
          user = document.querySelector('.login-user').value;
          start = Date.now();
          _context4.next = 7;
          return getAvb(user, model, color);

        case 7:
          end = Date.now();
          elapsed = (end - start) / 1000;
          console.log("Elapsed time: ".concat(elapsed));
          _context4.next = 13;
          break;
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            user = document.querySelector('.user-inputs input:nth-child(1)').value;
            pwd = document.querySelector('.user-inputs input:nth-child(2)').value;
            _context6.next = 4;
...
function getAvb(_x, _x2, _x3) {
  return _getAvb.apply(this, arguments);
} // Collapsible utilities


function _getAvb() {
  _getAvb = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(user, model, color) {
    var res, skus;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            ...
            _context13.next = 4;
            return fetch("/api/avb/".concat(session.user, "/").concat(model, "/").concat(color)).then(function (response) {
          ...
          case 4:
            ...
            skus.forEach(function (sku, i) {
                    ...
                    while (1) {
                      switch (_context7.prev = _context7.next) {
                        case 0:
                          ...
                          e.preventDefault();
                          e.stopPropagation();
                          img = document.querySelector(".sku-picture-".concat(i));
                          ...
                          _context7.next = 8;
                          return fetch("api/image/".concat(sku.year, "/").concat(sku.season, "/").concat(sku.model)).then(function (res) {
                            return res.text();
                          }).then(function (url) {
                            return img.src = url;
                          });
              ...
              var sizesWrapper = make('ul', 'sizes-wrapper', skusWrapper);
              skuElement.addEventListener('click', /*#__PURE__*/function () {
                var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(event) {
                  var dotLoader, shopsPromises, y, shopsObject, _res;
                    ...
                    while (1) {
                      switch (_context9.prev = _context9.next) {
                        case 0:
                          ...
                          dotLoader = make('img', 'sizes-loader f-width', skuElement);
                          dotLoader.src = "../loading.gif"; // array for promises
                        ...
                        case 19:
                          // print out the shops
                          _res.forEach(function (item, z) {
                            var index = Object.keys(item)[0];
                            var size = Object.keys(item[index]);
                            console.log(sku);
                            var sizeLabelElement = make('li', "size-".concat(z), sizesWrapper);
                            var sizeRow = maker("div", {
                              class: "size size-row flex"
                            }, sizeLabelElement);
                            var sizeLabel = maker("label", {
                              class: "label label-size",
                              size: sku.sizesForRequests[z],
                              // click to add to orders
                              on: ["click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
                                  ...
                                  while (1) {
                                    switch (_context8.prev = _context8.next) {
                                      case 0:
                                        ...
                                        _context8.next = 4;
                                        return fetch("/api/addOrder/".concat(session.user, "/").concat(sku.year, "/").concat(sku.season, "/").concat(sku.model, "/").concat(sku.color, "/").concat(size, "/").concat(sku.sizesForRequests[z])).then(function (res) {
                                          return res.json();
                                        }).then(function (json) {
                            ...
                            var toAddPopup = maker("span", {
                              class: "label to-add-popout",
                              text: "Add to orders"
                            }, sizeRow);
                            var sizeList = make('ul', 'size=list', sizeLabelElement);
                            var shops = Object.values(item[index])[0];
                            shops.forEach(function (item) {
                              var shop = make('li', 'shop', sizeList);
                          ...
                          dotLoader.classList.add('hidden'); // sizeswrapper set maxHeight for the first time
              ...
              var labelsWrapper = make('div', 'row labels-wrapper flex', skuElement); // print color desc

              var colorDescription = make('div', 'label label-description', labelsWrapper);
              colorDescription.textContent = "".concat(sku.descr); // print the price

              var priceElement = make('div', 'label label-price', firstRow);

              var priceGetter = /*#__PURE__*/function () {
                  ...
                  return regeneratorRuntime.wrap(function _callee10$(_context10) {
                    while (1) {
                      switch (_context10.prev = _context10.next) {
                        case 0:
                          _context10.next = 2;
                          return fetch("/api/price/".concat(sku.year, "/").concat(sku.season, "/").concat(sku.model)).then(function (price) {
                            return price.json();
                          });
              ...
              var getReceivables = /*#__PURE__*/function () {
                var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
                  var url, res, total, receivableSizes, receivableQty;
                  return regeneratorRuntime.wrap(function _callee11$(_context11) {
                    while (1) {
                      switch (_context11.prev = _context11.next) {
                        case 0:
                          url = "/api/request/".concat(sku.year, "/").concat(sku.season, "/").concat(sku.model, "/").concat(sku.color);
                          console.log(url);
                          _context11.next = 4;
                        ...
                        case 4:
                          ...
                          if (res.total != "") {
                            total = make("div", "label label-receivables", labelsWrapper);
                            total.textContent = res.total + ' da ricevere: ';
                            total.setAttribute('model', sku.model);
                            total.setAttribute('color', sku.color);
                            receivableSizes = Object.keys(res.receivables);
                            receivableQty = Object.values(res.receivables);
                            console.log("".concat(sku.year, "/").concat(sku.season, "/").concat(sku.model, " ").concat(receivableSizes.length, " "));
                            receivableSizes.forEach(function (item, j) {
                              total.innerHTML += "<div class=\"label label-size\">".concat(receivableQty[j], "/").concat(item, " </div>"); // console.log(total.innerHTML);
                            });
                          }
                ...
                return function getReceivables() {
                  return _ref7.apply(this, arguments);
                };
              }();

              getReceivables();
              sku.sizes.forEach(function (item) {
                var sizeElement = make('div', 'label label-size', labelsWrapper);
                sizeElement.textContent = item;
              });
            });
            collapsibles('.sku', '.sizes-wrapper');
            collapsibles('.sku', '.sizes-wrapper');
            document.querySelectorAll('.total-receivables').forEach(function (item) {
              item.addEventListener('click', /*#__PURE__*/function () {
                var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(event) {
                  var model, color, rnd, receivables;
                    ...
                    while (1) {
                      switch (_context12.prev = _context12.next) {
                        case 0:
                          ...
                          rnd = event.target.getAttribute('rnd');
                          _context12.next = 5;
                          return fetch("api/toReceive/".concat(model, "/").concat(color, "/").concat(rnd)).then(function (res) {
                            return res.json();
                          });

                        case 5:
                          receivables = _context12.sent;
                          console.log(receivables);

                          if (receivables) {
                            item.textContent = '';
                            Object.keys(receivables).forEach(function (s) {
                              var size = s;
                              var qty = Object.values(receivables[s]);
                              item.textContent += "".concat(qty, "/").concat(size, " ");
                            });
                          }
...
function collapsibles(parent, child) {
  ...
  document.querySelectorAll(parent).forEach(function (item, i) {
    item.onclick = function (event) {
      classy(children[i], 'collapsed', 'toggle');
      classy(children[i], 'collapsible', 'toggle');

      if (children[i].classList.contains('collapsible')) {
        var h = children[i].scrollHeight;
        children[i].setAttribute('style', "max-height: ".concat(h, "px;"));
      } else {
...
function maker(element, attrs, parent) {
  ...
  var attibutes = Object.keys(attrs);
  var values = Object.values(attrs);
  attibutes.forEach(function (item, i) {
    if (item === 'text') {
      elem.textContent = values[i];
    } else if (item === 'on') {
      var event = values[i][0];
      var callback = values[i][1];
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","mithril":"../node_modules/mithril/index.js","/components/Tabs":"components/Tabs.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
