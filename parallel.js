...
async function getToBeReceived(headers, sku) {
...
async function availabilityRequest(model, color, withImage) {
...
async function getAvb(model, color, withImage) {
  try {
    let results = await availabilityRequest(model, color, withImage);
    return results
  } catch (e) {
