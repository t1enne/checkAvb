...
var Tabs = /** @class */ (function () {
    ...
    Tabs.prototype.view = function (_a) {
        ...
        return m('', __assign(__assign({}, htmlAttrs), { class: classnames(Classes.TABS, align && "cui-align-" + align, bordered && Classes.TABS_BORDERED, fluid && Classes.FLUID, size && "cui-" + size, classname) }), children);
    };
    return Tabs;
}());
export { Tabs };
