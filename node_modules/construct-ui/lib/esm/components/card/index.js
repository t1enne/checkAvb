...
var Card = /** @class */ (function () {
    ...
    Card.prototype.view = function (_a) {
        ...
        return m('', __assign(__assign({}, htmlAttrs), { class: classnames(Classes.CARD, elevation && "cui-elevation-" + (elevation || 1), fluid && Classes.FLUID, interactive && Classes.CARD_INTERACTIVE, size && "cui-" + size, className) }), children);
    };
    return Card;
}());
export { Card };
