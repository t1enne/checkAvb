...
.cui-control {
  ...
  .cui-control .cui-control-indicator {
    ...
    margin: 0;
    border-radius: 2px;
    transition: background 200ms cubic-bezier(0.4, 1, 0.75, 0.9); }
...
.cui-breadcrumb {
  ...
  .cui-breadcrumb .cui-breadcrumb-item {
    ...
    color: #607d8b;
    transition: color 200ms cubic-bezier(0.4, 1, 0.75, 0.9); }
...
.cui-button {
  ...
  .cui-button-group.cui-basic .cui-button {
    ...
    .cui-button-group.cui-basic .cui-button:hover {
      ...
      border: solid 1px transparent;
      text-decoration: none; }
    .cui-button.cui-basic:active, .cui-button.cui-basic.cui-active,
    .cui-button-group.cui-basic .cui-button:active,
    .cui-button-group.cui-basic .cui-button.cui-active {
      background: #e7e8e9;
      border: solid 1px transparent;
      box-shadow: none; }
    .cui-button.cui-basic[disabled], .cui-button.cui-basic.cui-disabled,
  ...
  .cui-button.cui-primary.cui-outlined .cui-button-sublabel, .cui-button.cui-positive.cui-basic .cui-button-sublabel,
  .cui-button.cui-positive.cui-outlined .cui-button-sublabel, .cui-button.cui-negative.cui-basic .cui-button-sublabel,
  .cui-button.cui-negative.cui-outlined .cui-button-sublabel, .cui-button.cui-warning.cui-basic .cui-button-sublabel,
...
.cui-button-group.cui-primary .cui-button {
  ...
  .cui-button-group.cui-primary .cui-button:hover {
    ...
    text-decoration: none; }
  .cui-button.cui-primary:active, .cui-button.cui-primary.cui-active,
  ...
  .cui-button-group.cui-primary .cui-button.cui-active {
    ...
    box-shadow: inset 0px 4px 5px #4a569a; }
  .cui-button.cui-primary[disabled], .cui-button.cui-primary.cui-disabled,
...
.cui-button-group.cui-primary.cui-basic .cui-button {
  ...
  .cui-button-group.cui-primary.cui-basic .cui-button:hover {
    ...
    border: solid 1px transparent;
    text-decoration: none; }
  .cui-button.cui-primary.cui-basic:active, .cui-button.cui-primary.cui-basic.cui-active,
  .cui-button-group.cui-primary.cui-basic .cui-button:active,
  .cui-button-group.cui-primary.cui-basic .cui-button.cui-active {
    background: #dee1f2;
    border: solid 1px transparent;
    box-shadow: none; }
  .cui-button.cui-primary.cui-basic[disabled], .cui-button.cui-primary.cui-basic.cui-disabled,
...
.cui-button-group.cui-primary.cui-outlined .cui-button {
  ...
  .cui-button-group.cui-primary.cui-outlined .cui-button:hover {
    ...
    border: solid 1px #4a569a;
    text-decoration: none; }
  .cui-button.cui-primary.cui-outlined:active, .cui-button.cui-primary.cui-outlined.cui-active,
  ...
  .cui-button-group.cui-primary.cui-outlined .cui-button.cui-active {
    ...
    border: solid 1px #404b86;
    box-shadow: none; }
  .cui-button.cui-primary.cui-outlined[disabled], .cui-button.cui-primary.cui-outlined.cui-disabled,
...
.cui-button-group.cui-positive .cui-button {
  ...
  .cui-button-group.cui-positive .cui-button:hover {
    ...
    text-decoration: none; }
  .cui-button.cui-positive:active, .cui-button.cui-positive.cui-active,
  .cui-button-group.cui-positive .cui-button:active,
  .cui-button-group.cui-positive .cui-button.cui-active {
    background: linear-gradient(180deg, #4caf50 10.5%, #388e3c 100%);
    border: solid 1px #357b38;
    box-shadow: inset 0px 4px 5px #3d8c40; }
  .cui-button.cui-positive[disabled], .cui-button.cui-positive.cui-disabled,
...
.cui-button-group.cui-positive.cui-basic .cui-button {
  ...
  .cui-button-group.cui-positive.cui-basic .cui-button:hover {
    ...
    border: solid 1px transparent;
    text-decoration: none; }
  .cui-button.cui-positive.cui-basic:active, .cui-button.cui-positive.cui-basic.cui-active,
  .cui-button-group.cui-positive.cui-basic .cui-button:active,
  .cui-button-group.cui-positive.cui-basic .cui-button.cui-active {
    background: #dbefdc;
    border: solid 1px transparent;
    box-shadow: none; }
  .cui-button.cui-positive.cui-basic[disabled], .cui-button.cui-positive.cui-basic.cui-disabled,
...
.cui-button-group.cui-positive.cui-outlined .cui-button {
  ...
  .cui-button-group.cui-positive.cui-outlined .cui-button:hover {
    ...
    border: solid 1px #357b38;
    text-decoration: none; }
  .cui-button.cui-positive.cui-outlined:active, .cui-button.cui-positive.cui-outlined.cui-active,
  ...
  .cui-button-group.cui-positive.cui-outlined .cui-button.cui-active {
    ...
    border: solid 1px #357b38;
    box-shadow: none; }
  .cui-button.cui-positive.cui-outlined[disabled], .cui-button.cui-positive.cui-outlined.cui-disabled,
...
.cui-button-group.cui-negative .cui-button {
  ...
  .cui-button-group.cui-negative .cui-button:hover {
    ...
    text-decoration: none; }
  .cui-button.cui-negative:active, .cui-button.cui-negative.cui-active,
  ...
  .cui-button-group.cui-negative .cui-button.cui-active {
    ...
    box-shadow: inset 0px 4px 5px #c3362b; }
  .cui-button.cui-negative[disabled], .cui-button.cui-negative.cui-disabled,
...
.cui-button-group.cui-negative.cui-basic .cui-button {
  ...
  .cui-button-group.cui-negative.cui-basic .cui-button:hover {
    ...
    border: solid 1px transparent;
    text-decoration: none; }
  .cui-button.cui-negative.cui-basic:active, .cui-button.cui-negative.cui-basic.cui-active,
  .cui-button-group.cui-negative.cui-basic .cui-button:active,
  .cui-button-group.cui-negative.cui-basic .cui-button.cui-active {
    background: #fdd9d7;
    border: solid 1px transparent;
    box-shadow: none; }
  .cui-button.cui-negative.cui-basic[disabled], .cui-button.cui-negative.cui-basic.cui-disabled,
...
.cui-button-group.cui-negative.cui-outlined .cui-button {
  ...
  .cui-button-group.cui-negative.cui-outlined .cui-button:hover {
    ...
    border: solid 1px #c3362b;
    text-decoration: none; }
  .cui-button.cui-negative.cui-outlined:active, .cui-button.cui-negative.cui-outlined.cui-active,
  ...
  .cui-button-group.cui-negative.cui-outlined .cui-button.cui-active {
    ...
    border: solid 1px #ab2f26;
    box-shadow: none; }
  .cui-button.cui-negative.cui-outlined[disabled], .cui-button.cui-negative.cui-outlined.cui-disabled,
...
.cui-button-group.cui-warning .cui-button {
  ...
  .cui-button-group.cui-warning .cui-button:hover {
    ...
    text-decoration: none; }
  .cui-button.cui-warning:active, .cui-button.cui-warning.cui-active,
  .cui-button-group.cui-warning .cui-button:active,
  .cui-button-group.cui-warning .cui-button.cui-active {
    background: linear-gradient(180deg, #fb8c00 10.5%, #ef6c00 100%);
    border: solid 1px #ac5700;
    box-shadow: inset 0px 4px 5px #c46300; }
  .cui-button.cui-warning[disabled], .cui-button.cui-warning.cui-disabled,
...
.cui-button-group.cui-warning.cui-basic .cui-button {
  ...
  .cui-button-group.cui-warning.cui-basic .cui-button:hover {
    ...
    border: solid 1px transparent;
    text-decoration: none; }
  .cui-button.cui-warning.cui-basic:active, .cui-button.cui-warning.cui-basic.cui-active,
  .cui-button-group.cui-warning.cui-basic .cui-button:active,
  .cui-button-group.cui-warning.cui-basic .cui-button.cui-active {
    background: #fde5cc;
    border: solid 1px transparent;
    box-shadow: none; }
  .cui-button.cui-warning.cui-basic[disabled], .cui-button.cui-warning.cui-basic.cui-disabled,
...
.cui-button-group.cui-warning.cui-outlined .cui-button {
  ...
  .cui-button-group.cui-warning.cui-outlined .cui-button:hover {
    ...
    border: solid 1px #c46300;
    text-decoration: none; }
  .cui-button.cui-warning.cui-outlined:active, .cui-button.cui-warning.cui-outlined.cui-active,
  ...
  .cui-button-group.cui-warning.cui-outlined .cui-button.cui-active {
    ...
    border: solid 1px #ac5700;
    box-shadow: none; }
  .cui-button.cui-warning.cui-outlined[disabled], .cui-button.cui-warning.cui-outlined.cui-disabled,
...
.cui-card {
  ...
  .cui-card.cui-elevation-1 {
    box-shadow: 0px 2px 4px -2px rgba(67, 90, 111, 0.3); }
  .cui-card.cui-elevation-2 {
    box-shadow: 0px 5px 8px -4px rgba(67, 90, 111, 0.3); }
  .cui-card.cui-elevation-3 {
    box-shadow: 0px 8px 10px -4px rgba(67, 90, 111, 0.3); }
...
.cui-spinner {
  ...
  justify-content: center;
  opacity: 0;
  transition: opacity 300ms ease-in-out, visibility 0s ease-in-out 300ms, background 300ms ease-in-out;
  user-select: none;
  will-change: opacity;
  visibility: hidden; }
...
.cui-tabs-item {
  ...
  transition: color 200ms cubic-bezier(0.4, 1, 0.75, 0.9), border 200ms cubic-bezier(0.4, 1, 0.75, 0.9); }
...
.cui-tree-node-caret {
  color: #37474f;
  display: inline-block;
  transition: transform 400ms cubic-bezier(0.4, 1, 0.75, 0.9);
