...
var ButtonGroup = /** @class */ (function () {
    ...
    ButtonGroup.prototype.view = function (_a) {
        ...
        return mithril_1.default('', tslib_1.__assign(tslib_1.__assign({}, htmlAttrs), { class: classnames_1.default(_shared_1.Classes.BUTTON_GROUP, rounded && _shared_1.Classes.ROUNDED, fluid && _shared_1.Classes.FLUID, basic && _shared_1.Classes.BASIC, outlined && _shared_1.Classes.OUTLINED, intent && "cui-" + intent, size && "cui-" + size, className) }), children);
    };
    return ButtonGroup;
}());
