...
var FormGroup = /** @class */ (function () {
    ...
    FormGroup.prototype.view = function (_a) {
        ...
        var classes = classnames_1.default(_shared_1.Classes.FORM_GROUP, disabled && _shared_1.Classes.DISABLED, className);
        var innerContent = [
            label && mithril_1.default(FormLabel_1.FormLabel, label),
            content || children
        ];
        return mithril_1.default(grid_1.Col, tslib_1.__assign({ class: classes, span: span }, htmlAttrs), innerContent);
    };
    return FormGroup;
}());
