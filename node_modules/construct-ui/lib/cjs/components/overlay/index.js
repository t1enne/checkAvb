...
var Overlay = /** @class */ (function (_super) {
    ...
    Overlay.prototype.view = function () {
        ...
        var innerContent = [
            hasBackdrop && mithril_1.default('', {
                class: classnames_1.default(_shared_1.Classes.OVERLAY_BACKDROP, backdropClass),
                onmousedown: this.handleBackdropMouseDown,
                tabindex: 0
            }),
            content
        ];
        var classes = classnames_1.default(_shared_1.Classes.OVERLAY, inline && _shared_1.Classes.OVERLAY_INLINE, className);
        ...
        return inline ? container : mithril_1.default(portal_1.Portal, tslib_1.__assign({}, portalAttrs), container);
    };
    Overlay.prototype.handleOpen = function (contentEl) {
        ...
        if (hasBackdrop && !inline) {
            ...
            var bodyHasScrollbar = _shared_1.hasScrollbar(document.body);
            if (bodyHasScrollbar) {
                document.body.style.paddingRight = _shared_1.getScrollbarWidth() + "px";
            }
        }
        _shared_1.safeCall(onOpened, contentEl);
        this.handleFocus();
    };
