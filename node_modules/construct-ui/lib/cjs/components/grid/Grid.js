...
var Grid = /** @class */ (function () {
    ...
    Grid.prototype.view = function (_a) {
        ...
        var classes = classnames_1.default(_shared_1.Classes.GRID, align && _shared_1.Classes.GRID + "-align-" + align, justify && _shared_1.Classes.GRID + "-justify-" + justify, className);
        var breakPointGutter = this.getGutter(attrs);
        var styles = tslib_1.__assign(tslib_1.__assign({}, _shared_1.normalizeStyle(style)), { marginLeft: "-" + breakPointGutter / 2 + "px", marginRight: "-" + breakPointGutter / 2 + "px" });
        return mithril_1.default(element || '', tslib_1.__assign(tslib_1.__assign({}, htmlAttrs), { class: classes, style: styles }), this.renderCols(children, breakPointGutter));
    };
    ...
    Grid.prototype.renderCols = function (children, gutter) {
        ...
        return children.map(function (col) {
            ...
            col.attrs = col.attrs || {};
            col.attrs.style = tslib_1.__assign(tslib_1.__assign({}, _shared_1.normalizeStyle(col.attrs.style)), { paddingLeft: gutter / 2 + "px", paddingRight: gutter / 2 + "px" });
            return col;
        });
    };
    return Grid;
