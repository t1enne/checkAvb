...
var BreadcrumbItem = /** @class */ (function () {
    ...
    BreadcrumbItem.prototype.view = function (_a) {
        ...
        var classes = classnames_1.default(_shared_1.Classes.BREADCRUMB_ITEM, className);
        return mithril_1.default(tag, tslib_1.__assign(tslib_1.__assign({}, htmlAttrs), { class: classes }), children);
    };
