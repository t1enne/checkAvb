...
var PopoverMenu = /** @class */ (function () {
    ...
    PopoverMenu.prototype.view = function (_a) {
        ...
        return mithril_1.default(popover_1.Popover, tslib_1.__assign(tslib_1.__assign({}, popoverAttrs), { class: classnames_1.default(__1.Classes.POPOVER_MENU, className), content: mithril_1.default(menu_1.Menu, tslib_1.__assign({}, menuAttrs), content) }));
    };
    return PopoverMenu;
}());
