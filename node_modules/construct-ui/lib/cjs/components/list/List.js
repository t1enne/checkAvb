...
var List = /** @class */ (function () {
    ...
    List.prototype.view = function (_a) {
        ...
        return mithril_1.default('', tslib_1.__assign(tslib_1.__assign({}, htmlAttrs), { class: classnames_1.default(_shared_1.Classes.LIST, interactive && _shared_1.Classes.INTERACTIVE, size && "cui-" + size, className) }), children);
    };
    return List;
}());
exports.List = List;
